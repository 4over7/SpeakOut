...
class ConfigService {
  ...
  Future<void> setAliyunCredentials(String id, String secret, String appKey) async {
    // If empty strings, revert to defaults (remove key so fallback kicks in)
  ...
  // --- Agent Router Config ---
  // Agent Router can use a different model (e.g., one better at JSON output)
