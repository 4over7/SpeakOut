  ...
  static const List<CloudProvider> all = [
    ...
    CloudProvider(
      ...
      credentialFields: [
        ...
        CredentialField(key: 'asr_api_key', label: '豆包语音 API Key', isSecret: true, scope: {CloudCapability.asrStreaming}, placeholder: '在豆包语音新版控制台 → API Key管理 中获取'),
      ],
      capabilities: {CloudCapability.asrStreaming, CloudCapability.llm},
      asrModels: [
      ...
      llmModels: [
        ...
        CloudLLMModel(id: 'doubao-1-5-pro-32k-250115', name: 'Doubao 1.5 Pro 32K', priceHint: '0.0004 元/千 token'),
        CloudLLMModel(id: 'doubao-1-5-lite-32k-250115', name: 'Doubao 1.5 Lite 32K', priceHint: '0.0003 元/千 token'),
      ],
    ...
    CloudProvider(
      ...
      llmModels: [
        ...
        CloudLLMModel(id: 'moonshotai/kimi-k2-instruct-0905', name: 'Kimi K2 (via Groq)', description: 'MoE 旗舰'),
      ],
    ...
    CloudProvider(
      ...
      llmModels: [
        ...
        CloudLLMModel(id: 'glm-z1-airx', name: 'GLM-Z1 AirX', description: '超快速'),
      ],
    ...
    CloudProvider(
      ...
      capabilities: {CloudCapability.llm},
      llmModels: [
        CloudLLMModel(id: 'kimi-k2.6', name: 'Kimi K2.6', description: '推荐，比 K2.5 快一倍'),
        CloudLLMModel(id: 'kimi-k2.5', name: 'Kimi K2.5', description: 'MoE 旗舰，较慢'),
      ...
      llmDefaultModel: 'kimi-k2.6',
      llmModelHint: '如 kimi-k2.6, kimi-k2.5',
    ...
    CloudProvider(
      ...
      capabilities: {CloudCapability.llm},
      llmModels: [
        CloudLLMModel(id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', description: '推荐，极快', priceHint: '0.02 元/千 token'),
        CloudLLMModel(id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', description: '旗舰', priceHint: '0.09 元/千 token'),
        CloudLLMModel(id: 'gemini-2.0-flash', name: 'Gemini 2.0 Flash', description: '将于 2026-06 下线'),
      ],
      llmBaseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai',
      llmDefaultModel: 'gemini-2.5-flash',
